	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{ url('/home') }}"><span>Admin Dashboard</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#" onclick="document.getElementById('logoutForm').submit();"><i class="halflings-icon off"></i> Logout</a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a href="form.html" class="dropmenu"><i class="icon-edit"></i><span class="hidden-tablet"> Slider</span></a>
							<ul>
