                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="{{ url('product-by-category',['id'=>$published_category->id]) }}">{{ $published_category->category_name }}</a></h4>
                                    </div>
                                </div>
                                <?php } ?>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{ url('products-by-manufacture',['id'=>$published_manufacture->id]) }}"> <span class="pull-right">(50)</span>{{ $published_manufacture->manufacture_name }}</a></li>
                                    <?php } ?>
                                </ul>
