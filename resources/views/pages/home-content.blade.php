        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                    ...
                    <img src="{{ asset($publishedproduct->product_image) }}" alt="">
                    <h2>TK. {{ $publishedproduct->product_price }}</h2>
                    <p>{{ $publishedproduct->product_name }}</p>
            ...
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="#"><i class="fa fa-plus-square"></i>{{ $publishedproduct->manufacture_name }}</a></li>
                    <li><a href="{{ url('product-details') }}"><i class="fa fa-plus-square"></i>View Product</a></li>
                </ul>
            </div>
        </div>
    </div>
