                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <img src="{{ asset($productmanufacture->product_image) }}" alt="">
                                            <h2>TK. {{ $productmanufacture->product_price }}</h2>
                                            <p>{{ $productmanufacture->product_name }}</p>
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><a href="#"><i class="fa fa-plus-square"></i>{{ $productmanufacture->manufacture_name }}</a></li>
